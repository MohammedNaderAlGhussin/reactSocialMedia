    ...
    <main className="linear h-screen flex justify-center items-center">
      <div className="bg-white flex flex-col justify-center container gap-5 mx-auto rounded-xl p-5 md:p-10 w-4/5 sm:w-2/3 md:w-3/5 lg:w-4/10 xl:w-3/9  h-[670px]">
        <div className="flex flex-col items-center justify-center">
          <div className="linear w-fit text-white px-2 py-1 mb-4">Logo</div>
        ...
        <form className=" flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="pass" className="text-main-text">
              Password
            </label>
            <input
              type="text"
        ...
        <div className="flex flex-row justify-around items-center">
          <div className="border-2 border-light-border flex flex-row justify-center items-center px-3 py-3 md:px-5  rounded-2xl gap-3 ">
